...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container">
            ...
            <div class="masthead-heading text-uppercase">@yield('myname')</div>
            ...
            <div class="row">
                ...
                <div style="width:100%; position: relative;" class="btn btn-primary btn-xl text-uppercase">
                    <form action="{{ route('name.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <label style="text-align: center;margin-left: -45px" for="">Enter Category:</label>
                        <input type="text" name="category" placeholder="Category" id=""><br><br>
                        <label for="">Enter Description:</label><br>
                        <textarea style="width: 70%" placeholder="Description" name="description" id="" cols="30"
                            rows="10"></textarea><br><br>
                        <label for="">Choose Image:</label><br>
                        <input style="position: absolute; left:45%;margin-top: 10px" type="file" name="file"
                            id=""> <br><br>
                        @if ($errors->any())
